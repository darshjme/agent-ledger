...
[![Zero Dependencies](https://img.shields.io/badge/Dependencies-Zero-brightgreen?style=flat-square)](https://github.com/darshjme/agent-ledger)
[![Tests](https://img.shields.io/badge/Tests-Passing-success?style=flat-square)](https://github.com/darshjme/agent-ledger/actions)
...
`agent-ledger` implements **audit logging and action ledger for agents — ledgerentry, ledger with query/filter, @audit decorator. zero dependencies.**

Inspired by the Vedic principle of *लेखा* (Lekha), this library brings the ancient wisdom of structured discipline to modern LLM agent engineering.
...
Production LLM systems fail in predictable ways. `agent-ledger` solves the **ledger** failure mode with:
...
`agent-ledger` is part of **[darshjme/arsenal](https://github.com/darshjme/arsenal)** — a collection of 100 focused Python libraries for LLM agent infrastructure.

Each library solves exactly one problem. Together they form a complete stack.

```
pip install agent-ledger  # this library
